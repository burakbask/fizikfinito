...
// Action: when form is submitted, save suggestion to Directus
...
// React component: modal popup and spam prevention
export default function MesajSayfasi() {
  const actionData = useActionData();
  const [showModal, setShowModal] = useState(false);

  // Inject CSS to hide scrollbars automatically
  useEffect(() => {
  ...
  // Prevent more than 5 submissions per day
          ...
          <Form method="post" onSubmit={handleSubmit} className="mt-6 space-y-6">
            ...
            <fieldset className="space-y-2">
              <legend className="text-sm font-medium text-gray-700">
                Sizi en iyi hangisi tanımlıyor? <span className="text-red-500"></span>
              </legend>
